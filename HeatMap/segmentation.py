...
def Deeplabv3(weights='pascal_voc', input_tensor=None, input_shape=(512, 512, 3), classes=1, backbone='mobilenetv2',
...
deeplab = Deeplabv3(input_shape = (800,800,3))
if __name__ == "__main__":
    model = Deeplabv3(input_shape = (800,800,3))
    model.summary()